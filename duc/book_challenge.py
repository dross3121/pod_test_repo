...
'''
my_library.remove_title(title = 'Just Mercy', author = 'Bryan Stevenson')
...
nyt_bestsellers.add(title = 'On Tyranny', author= 'Timothy Snyder')
nyt_bestsellers.add(title = 'Bourdain', author= 'Laurie Woolever')
