...
# def availble_books(data):
#     # for book in books:
#     print(data)
# availble_books(books)
...
#     if book in books:
#         print('Its available, would you like to check it out?')
#     else:
#         print('Its not available, would you like us to hold it for you?')
...
print(type(books_with_details[6]))
# I'm using the "type" function to identify what types are nested within others. Obviously, I'm looking in "books_with_details and just the "[]" for numeric indexing because it's it's a list. So with this code I'm able to move around the nested data to identify them.
# Using the type function. Also, there are multiple dictionaries nested within each other.
