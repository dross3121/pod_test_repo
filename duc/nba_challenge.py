...
# fred_vanvlee_3pts_made = 43
# james_harden_3pts_made = 37
# # TODO: Create variable here for number of 3 pt shots made by Fred VanVlee
# # TODO: Create variable here for number of 3 pt shots made by James Harden
print()
# print("Challenge 2.2:")
# print(f"In the 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made} 3 point shots")
# print(f"In the 2020 NBA playoffs, Fred VanVlee made {fred_vanvlee_3pts_made} 3 point shots")
...
# fred_vanvlee_3pts_attempts = 110
...
# "f" 3 point shots and {jamal_murray_3pts_attempts} 3 point shot attempts")
# print(f"In the 2020 NBA playoffs, Fred VanVlee made {fred_vanvlee_3pts_made} 
# "f" 3 point shots and {fred_vanvlee_3pts_attempts} 3 point shot attempts")
# print(f"In the 2020 NBA playoffs, James Harden made {james_harden_3pts_made} 
# "f" 3 point shots and {james_harden_3pts_attempts} 3 point shot attempts")
...
# fred_vanvlee_3pts_percentage = fred_vanvlee_3pts_made/fred_vanvlee_3pts_attempts
...
# print(f"In the 2020 NBA playoffs, Fred VanVlee's 3 point percentage was {fred_vanvlee_3pts_percentage}")
