...
print(f"In the 2020 NBA playoffs, Fred VanVlet made {fred_vanvleet_3pts_made} 3 point shots")
...
print(f"In the 2020 NBA playoffs, Fred VanVlet made {fred_vanvleet_3pts_made} 3 point shots and {fred_vanvleet_3pts_attempts} 3 point attempts")
print(f"In the 2020 NBA playoffs, James Harden made {james_harden_3pts_made} 3 point shots and {james_harden_3pts_attempts} 3 point attempts")
...
print('Do you think the Los Angeles Lakers are a good basketball team? Pick Yes or No')

lakers_are_best = ('Yes')
lakers_are_best_2 = ('No')

print(f'Do you think the Los Angeles Lakers are a good basketball team? Pick Yes or No')
print(lakers_are_best)
print(lakers_are_best_2)
...
jamal_murray_3pts_percentage = str(3)
print(type(jamal_murray_3pts_percentage))

fred_vanvleet_3pts_percentage = str(3)
print(type(fred_vanvleet_3pts_percentage))

james_harden_3pts_percentage = str(3)
print(type(james_harden_3pts_percentage))


# TODO: Take each player's three point percentage (from part 2.5) and convert it to an integer, then print it out.

jamal_murray_3pts_percentage = int(3)
print(type(jamal_murray_3pts_percentage))

fred_vanvleet_3pts_percentage = int(3)
print(type(fred_vanvleet_3pts_percentage))

james_harden_3pts_percentage = int(3)
print(type(james_harden_3pts_percentage))