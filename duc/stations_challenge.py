...
# station3 = BusStation('NYC Mega Bus Stop', '34 Street & 12th Avenue', ['Boston', 'DC', 'Philly'])
# station3.show_info()
...
'''
BlueLine = Metro("Union Station", "Chinatown bordering DTLA", ['Blue Line', 'Expo Line', 'Gold Line', 'Purple Line'])
BlueLine.show_info()

la_station = MTA
locations = '11th and Wilshire Blvd.'
bus_lines = ['#215', '#456', '#908']

station3 = MTA('MTA Station', '11th and Wilshire Blvd.', ['#215', '#456', '#908'])
station3.show_info()
