...
tip =int(input('How much percentage do you want to pay as a tip? Dont be cheap:) . '))
...
# Use f string to print out the cost of food and tio amount using variables.
print(f'Your food cost ${foodcost} and your tip was ${amount_tip}.')
# Use f string to print out the total with tax.
print(f'Your total with tax is ${total}.')
# Print out amount each person will pay.
print(f'Each person will pay ${individual}.')
# Print a message for user using fstring and print function.
print(f'{name}, I hope that you guys enjoyed your meal and had a great time. Hoping the ${individual} was worth it! :)')