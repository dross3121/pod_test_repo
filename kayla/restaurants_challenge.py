...
my_restaurants1 = {
    ...
    "address": "123 address st. Address IN 46201"
}
my_restaurants2 = {
    "name": "mcburger",
...
print(my_restaurants1)
print(my_restaurants2)
print(my_restaurants3)
...
print()
del my_restaurants1["favorite_dish"]
print(my_restaurants1)
print("Question 4")
'''
...
my_restaurants2.update({"address":"123 2nd st second in 46201"})
