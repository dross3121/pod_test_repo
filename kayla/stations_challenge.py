...
s1 = SubwayStation("Subway_Station", "Peru, IN", [])

print(s1.station_name,s1.location,s1.lines)
'''
...
#      lines: ['1', '2', '3', 'L']
sbw_14 = SubwayStation("14th Street", "14th Street and 7th Avenue", ['1', '2', '3', 'L'])
print(sbw_14.station_name,sbw_14.location,sbw_14.lines)
...
class BusStation:
    def __init__(self, station_names, locations, open, routes=[]):
        self.station_names = station_names
        self.locations = locations
        self.open=open
        self.routes = routes
    
    def open_staton(self):
        print(f'{self.station_names} station is located at {self.locations} and is {self.open}')

class AnotherStation(BusStation):
    def __init__(self, station_names, locations, open, routes):
        self.station_names
        self.locations
        self.open
        self.routes
sbw = BusStation("New Station", "Indinapolis", True, ['DC', 'Philly', 'Pittsburgh'])


print(sbw.station_names,sbw.locations,sbw.open,sbw.routes)
...
'''
NYC = BusStation("NYC Megabus Stop", "34th street and 12th avenue", True, ["Boston", "DC", "Philly"])
print(NYC.station_names,NYC.locations,NYC.open,NYC.routes)
