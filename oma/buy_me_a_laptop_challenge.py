...
print("1. The url for the Apple Macbook Pro ")
...
prices =  laptops[0]['types'][0]['price'], laptops[0]['types'][1]['price'], laptops[0]['types'][0]['price'], laptops[0]['types'][1]['price']
