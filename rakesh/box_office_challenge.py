...
# Using .split convert string to a list at every comma and type function to verify it has been converted to a list.
...
# Using .remove to remove The Matrix from list
...
# Using append to add Anywhere But Here at the end of list
...
# Using len to make sure list of movies is at 50
list_title_count = len(remaining_50_list)
print(list_title_count)
print()
...
# Using addition operator to combine 2 lists. Order wasn't specified.
...
# Using index 0 to print the first movie in the list
print(top_100[0])
print()

# TODO: Let's print the top 10 movies in "top_100" as a list. Let's use the slice syntax to accomplish this!
# Using slice syntax to print top 10 movies from the list.
print(top_100[0:10])
print()
...
# Converting the list back to string with .join and separting string with commas/space. Using type to show list has been converted to a string.
