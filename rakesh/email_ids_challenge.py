...
dot = "."
joined_names = dot.join(names_list)
#print (joined_names)
...
print(email) #Printing email to see if code worked
print()
...
for employee_email_list in names:
    lower_list_name = employee_email_list.lower()
    split_lower_names_list = lower_list_name.split()
    joined_email_names = dot.join(split_lower_names_list)
    email = joined_email_names + '@ripplemedia.com'
    emails.append(email)
print(emails) # Printing employee email list to check if for loop worked
