...
# 'artist' (string)
# 'title' (string)
first_song = {'artist': 'Depeche Mode', 'title': 'Enjoy The Silence'}
...
print('Question 5')
print()
add_song(my_playlist, {'artist': 'New Order', 'title': 'Temptation'})
add_song(my_playlist, {'artist': 'Front 242', 'title': 'Headhunter'})
display_playlist(my_playlist)
print()
