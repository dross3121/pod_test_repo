...
def get_playlist_length(playlist):
	number_of_tracks = len(playlist)
	print(f'You have {number_of_tracks} tracks in your playlist.' )
...
def play_track(playlist,track=1):
	...
	print(f'Now playing track {track}, {playlist[track-1]["title"]} by {playlist[track-1]["artist"]} with {playlist[track-1]["plays"]} play(s).')
