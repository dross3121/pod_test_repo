...
print(f"The value of d is False in an 'or' logical operator only if both sides of the 'or' are false.\
    \nBy adding 'not' to the first comparison, both sides of the or are false.")
print()
...
print (f"The value of o ({o}) is True since Python is case-sensitive, goat > GOAT.")
