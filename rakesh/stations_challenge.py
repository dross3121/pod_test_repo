...
lines: ['1', '2', '3', 'L']
'''
ex_subway_station = SubwayStation('14th street','14th street and 7th avenue',['1', '2', '3', 'L'])
ex_subway_station.show_info()
print()
...
class BusStation(Station):
    ...
    def show_info(self):
        if self.open == True:
            print(f'{self.station_name} station is located at {self.location} and travels on routes to {self.routes} and is currently open.')
        else:
              print(f'{self.station_name} station is located at {self.location} and travels on routes to {self.routes} and is currently closed.')
print()
...
'''
example_bus_station = BusStation(['Boston', 'DC', 'Philly'], 'NYC Megabus Stop', '34th street and 12th avenue')
example_bus_station.show_info()
print()
example_bus_station.close_station()
example_bus_station.show_info()
print()
