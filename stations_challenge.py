...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'The {self.station_name} station is located at {self.location} and can be accessed by the {self.lines} trains. ')
...
class BusStation(Station):
    ...
    def show_info(self):
        ...
        print(f'{self.station_name} station is located at {self.location}. This bus station has the following routes {self.routes}.')    
