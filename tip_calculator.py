...
greeting = input(
    f'Hello {name}. I will be happy to help you figure out the amount you have to spend on your meal. Press enter.')
...
tip = int(input(
    'How much percentage do you want to pay as a tip? Only enter the number. Dont be cheap :) . '))
...
taxes = input(
    'Please be aware that a 10% sales tax will be added to your bill. Press enter. ')
# Create a variable to find out how many people will be dividing the bill and give user a message.
people = float(input(
    'How many people are splitting the bill? I will assume that you will be dividing the bill equally. '))
