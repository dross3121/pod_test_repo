...
print(f"In the 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made} 3 point shots nad {jamal_murray_3pts_attempts} 3 point shot attempts")
print(f"In the 2020 NBA playoffs, Fred VanVleet made {fred_vanvleet_3pts_made} 3 point shots nad {fred_vanvleet_3pts_attempts} 3 point shot attempts")
print(f"In the 2020 NBA playoffs, James Harden made {james_harden_3pts_made} 3 point shots nad {james_harden_3pts_attempts} 3 point shot attempts")
...
print(f'Jamal Murray 3 point percentage is {jamal_murray_3pt_percentage}')
print(f'Fred VanVleet 3 point percentage is {fred_vanvleet_3pt_percentage}')
print(f'James Harden 3 point percentage is {james_harden_3pt_percentage}')
...
print(f'The statement that the Lakers are the best is {lakers_are_best}')
