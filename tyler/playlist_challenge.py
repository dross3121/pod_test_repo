...
# 'artist' (string)
# 'title' (string)
add_song(my_playlist,{'artist': 'Kota the Friend', 'title': 'Daylight'})
...
print('Question 5')
add_song(my_playlist,{'artist': '$uicideboy$', 'title': '...And to Those I Love Thanks for Sticking Around'})
add_song(my_playlist, {'artist': 'Beach House', 'title': 'Space Song'})
display_playlist(my_playlist)
